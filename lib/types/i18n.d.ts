...
export type FieldKey = 'enabled' | 'prefix' | 'maxSessions' | 'workspaceMode' | 'defaultWorkspacePath' | 'allowDiscover' | 'allowAdopt' | 'exposeErrors' | 'corsOrigin' | 'sseHeartbeatMs' | 'bodyTimeoutMs' | 'adminKey';
